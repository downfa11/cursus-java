...
public final class PostgresSagaTransaction implements SagaContracts.Transaction {
  ...
  public PostgresSagaTransaction(DataSource dataSource, String historyTopic) {
    delegate =
        new JdbcSagaTransaction(dataSource, historyTopic, JdbcSagaTransaction.Dialect.POSTGRES);
  }
